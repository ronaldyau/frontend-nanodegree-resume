...
var education = {
    ...
    "display": function() {
        ...
        for(var i = 0; i < education.onlineCourses.length; i++) {
            $('#education').append(HTMLschoolStart);
            var educationEntry = $('.education-entry:last');
            educationEntry.append(HTMLonlineTitle.replace('%data%', education.onlineCourses[i].title));
            educationEntry.append(HTMLonlineSchool.replace('%data%', education.onlineCourses[i].school));
            educationEntry.append(HTMLonlineDates.replace('%data%', education.onlineCourses[i].date));
            educationEntry.append(HTMLonlineURL.replace('%data%', education.onlineCourses[i].url));
        }
    }
}

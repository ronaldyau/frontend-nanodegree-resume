    ...
    "display": function() {
        ...
        for (var contact in bio.contacts) {
            if (bio.contacts.hasOwnProperty(contact)) {
                ...
                $('#topContacts, #footerContacts').append(contactItem);
            }
        }
...
var education = {
    ...
    "display": function() {
        ...
        for (var j = 0; j < education.onlineCourses.length; j++) {
            ...
            onlineCourse.append(HTMLonlineTitle.replace('%data%', education.onlineCourses[j].title));
            onlineCourse.append(HTMLonlineSchool.replace('%data%', education.onlineCourses[j].school));
            onlineCourse.append(HTMLonlineDates.replace('%data%', education.onlineCourses[j].date));
            onlineCourse.append(HTMLonlineURL.replace('%data%', education.onlineCourses[j].url));
        }
    }
};
